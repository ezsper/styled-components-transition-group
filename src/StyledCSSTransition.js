...
import { classNamesShape } from 'react-transition-group/utils/PropTypes';
...
class CSSTransition extends React.Component {
  ...
  reflowAndAddClass(node, className) { // eslint-disable-line class-methods-use-this
  ...
  registerNode = (component) => {
    this.node = ReactDOM.findDOMNode(component); // eslint-disable-line react/no-find-dom-node
